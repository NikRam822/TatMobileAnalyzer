...
|Commit Size|Measures the size or lines of code changed on each commit.| Programmers may start artificially increasing the amount of code.                                                                                                                              | 1. Helps you determine the scope of changes made by the developer to each commit. <br/>2. May indicate whether the developer makes a major or minor contribution. <br/>3. Полезно для понимания сложности и влияния изменений.   |
